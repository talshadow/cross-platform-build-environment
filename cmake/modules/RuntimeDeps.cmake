...
function(_ep_rt_write_file targets out_file)
    ...
    # Додаткові директорії деплою (ep_add_extra_deploy_dir)
    get_property(_extra_dirs GLOBAL PROPERTY _EP_BINARYDEPS_EXTRA_DEPLOY_DIRS)
    if(_extra_dirs)
    ...
    file(WRITE "${out_file}"
        ...
        "set(EP_EXTRA_DEPLOY_DIRS \"${_extra_dirs}\")\n"
        "${_body}")
endfunction()
